...
from schoolutils.institutions.ucberkeley import bcourses
...
class SimpleUI(BaseUI):
    ...
    def import_students(self):
        ...
        # assume, for now, that CSV files have been generated by bCourses:
        students = bcourses.gradebook_csv_to_students(csv_path)
...
class AssignmentTable(OrgTableUI):
    ...
    def update(self, org_table):
        ...
        # TODO: dynamically update self.column_info to reflect user's ordering??
        col_mapping = [(ti, ci)
        ...
        for row in org_table[1:]:
            ...
            if not query_args['name']:
                raise ValueError("Cannot update assignment without a name.") 
...
class GradeSpreadsheet(OrgTableUI):
    ...
    def build_column_info(self):
        """Dynamically build column information from assignment and
           student data for this course.
        """
        cols = [{'field': 'sid',
                 'pretty_name': 'SID',
                 'validator': validators.sid,
                 'visible': True}]
        # TODO: columns for first and last name
    ...
    def load(self):
        """Load grade data for this course from the grade database.
        """
        ...
        # TODO: also keep track of student names
        data = {}
        for s in students:
    ...
    def orgify(self):
        ...
        for sid, grade_rows in self.data.items():
            row = [sid] # TODO: add first and last names
    ...
    def update(self, org_table):
        """Update the grade database with data from an Org table.
        """
        headers = org_table[0]
